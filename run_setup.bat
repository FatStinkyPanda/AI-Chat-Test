...
echo ============================================================
echo Brain-Inspired AI - Setup Launcher
echo ============================================================
echo.
...
echo ============================================================
echo.
echo Python 3.10 was installed but cannot be found automatically.
echo.
echo Please locate your Python 3.10 installation:
echo   1. Open File Explorer
echo   2. Search for "python.exe" in C:\ drive
echo   3. Look for Python310 folder
echo.
...
echo.
echo Once found, run:
echo   "C:\path\to\Python310\python.exe" setup.py
echo.
pause
exit /b 1
